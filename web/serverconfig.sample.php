...
define('YAAMP_BTC_PAYMENTS_FREQ', 1*60*60);
define('YAAMP_PAYMENTS_MINI', 0.0125);
define('YAAMP_BTC_PAYMENTS_MINI', 0.0025);
...
'CWok9oNiyMQYmpwgEv1vVB1CLPYg1F32GU' => 0.0,
);
