...
echo '<p class="formHint2">Field will update on process name save</p>';
echo CUFHtml::closeCtrlHolder();}
...
echo '<p class="formHint2">For Coins on Dedicated Ports</p>';
echo CUFHtml::closeCtrlHolder();
...
echo '<p class="formHint2">Max 35 limit</p>';
echo CUFHtml::closeCtrlHolder();
        ...
        echo "rpcallowip=10.0.0.2\n";
        echo "rpcallowip=10.0.0.4\n";
        echo "rpcallowip=10.0.0.7\n";
        echo "rpcallowip=10.0.0.8\n";
        echo "rpcallowip=10.0.0.9\n";
        echo "rpcallowip=10.0.0.10\n";
        echo "rpcallowip=10.0.0.11\n";
				echo "rpcallowip=10.0.0.12\n";
	    	echo "rpcallowip=10.0.0.14\n";
        echo "# onlynet=ipv4\n";
        echo "maxconnections=25\n";
        echo "daemon=1\n";
        echo "gen=0\n";
        ...
        echo CHtml::closetag("pre");
				...
				echo CHtml::tag("hr");
				echo "<b>Add coin to system startup</b>:";
				echo CHtml::opentag("pre");
				...
				echo CHtml::tag("hr");
        echo "<b>Helpful Daemon Commands</b>:";
        echo CHtml::opentag("pre");
